<?php
namespace Bomagalhaes\Magento2Correios\Model;

use Bomagalhaes\Magento2Correios\Api\ConsultaInterface;
use Bomagalhaes\Magento2Correios\Api\Data\Dados;
use Bomagalhaes\Magento2Correios\Model\Endereco\Correios;
use Bomagalhaes\Magento2Correios\Model\Endereco\Republicavirtual;
use Bomagalhaes\Magento2Correios\Model\Endereco\Viacep;
...
/**
 * Class Consulta
 * @package Bomagalhaes\Magento2Correios\Model
 */
class Consulta extends \Magento\Framework\DataObject implements Dados, ConsultaInterface
{
    ...
    /**
     * @var \Bomagalhaes\Magento2Correios\Helper\Sigep
     */
     ...
     * @param \Bomagalhaes\Magento2Correios\Helper\Sigep $helperSigep
     */
    public function __construct(\Magento\Directory\Model\Region $modelRegion,
                                ...
                                \Bomagalhaes\Magento2Correios\Helper\Sigep $helperSigep
    )
    {
        $this->_quote = $quote;
